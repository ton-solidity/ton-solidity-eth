...
{
public:
	explicit NoOutputAssembly(langutil::VMMachineAndVersion _evmVersion): m_evmVersion(_evmVersion) { }
	...
	langutil::VMMachineAndVersion evmVersion() const override { return m_evmVersion; }
